...
const CreateProfile = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Changed to use underscores consistently
    formData.append(
      "spoken_languages",
      JSON.stringify(
...
const CreateProfile = () => {
  ...
  useEffect(() => {
    if (user?.first_name) {
      // If user already has profile data, we're in edit mode
      setIsEditing(true);

      // Convert user's spoken languages to our form format
      ...
      // Convert user's learning languages to our form format
